...
\textbf{Note}: Since riboflavin is water soluble, the excess will either not be absorbed or, if absorbed, will be excreted via the kidneys into urine,
resulting in a bright yellow colour known as flavinuria. There have been no documented adverse effects from taking too much vitamin B\textsubscript{2}.
...
\begin{figure}[h]
	...
	\centering {
	\includegraphics[width=\textwidth]{images/Vitamin_E_chemical_structure_alpha_tocopherol}
	\includegraphics[width=\textwidth]{images/Vitamin_E_chemical_structure_beta_tocopherol}
	\includegraphics[width=\textwidth]{images/Vitamin_E_chemical_structure_gamma_tocopherol}
	\includegraphics[width=\textwidth]{images/Vitamin_E_chemical_structure_delta_tocopherol}
	}
\end{figure}
\newpage
