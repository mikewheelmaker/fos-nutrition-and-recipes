...
\begin{figure}[h]
	\caption{Chemical structure of niacin (left) and nicotinamide (right)}
	\centering{
		\includegraphics[width=0.33\textwidth]{images/Vitamin_B3_chemical_structure_niacin}
		 \includegraphics[width=0.37\textwidth]{images/Vitamin_B3_chemical_structure_nicotinamide}
	}
\end{figure}
...
\begin{table}[h]
	...
	\centering \begin{tabular}{| r | l | l |}
		\hline
		& Niacin & Nicotinamide\\ \hline
		Formula & C\textsubscript{6}H\textsubscript{5}NO\textsubscript{2} & C\textsubscript{6}H\textsubscript{6}N\textsubscript{2}O\\ \hline
		Molar mass & 123.111 g$\cdot$mol \textsuperscript{-1} & 122.127 g$\cdot$mol \textsuperscript{-1}\\ \hline
		SMILES & OC(=O)c1cccnc1 & c1cc(cnc1)C(=O)N\\ \hline
	\end{tabular}
\end{table}
\newpage
...
\begin{table}[h]
	...
	\centering \begin{tabular}{| r | l | l |}
		\hline
		\textbf{Life stage group} & \textbf{RDA or AI (mg NE/day)} & \textbf{UL (mg NE/day)}\\ \hline
		Infants (0--6 months) & 2 (AI) & unknown\\ \hline
		Infants (7--12 months) & 4 (AI) & unknown\\ \hline
